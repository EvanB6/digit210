...
<p:declare-step name="pokeMoves-to-xml" xmlns:p="http://www.w3.org/ns/xproc"
    ...
    <!-- ================================================================ -->
    <p:input port="source" primary="true" content-types="text/plain" href="pokemon-moves-gen5.txt"/>
    ...
    <p:invisible-xml cx:processor="markup-blitz">
        <p:with-input port="grammar">
            <p:document href="pokeHeader.ixml" content-type="text/plain"/>
        </p:with-input>
    </p:invisible-xml>
    ...
    <!-- ================================================================ -->
    <p:store name="simple-XML" href="pokeMovesGen5.xml"/>
    ...
    <!--    <p:with-input port="source">
        ...
        <p:with-input port="stylesheet" href="pokeSvg.xslt"/>
    </p:xslt>
    <p:identity message="Running the Identity Trnasformation XSLT to develop the svg"/>
    ...
    <p:store href="poke.svg" serialization="map {
        'method' : 'xhtml',
        'indent' : true(),
        'omit-xml-declaration' : false()
        }"/>
    <p:identity message="Saved finalized svg"/>
